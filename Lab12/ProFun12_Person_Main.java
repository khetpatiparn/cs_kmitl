public class ProFun12_Person_Main {
    ...
    static void demo_1_initialize_object() {
        ...
        Person_660253 yd = new Person_660253("yindee", 2000 );
        Person_660253 pd = new Person_660253("Preeda", 1000);
        yd.introduce_self();
        pd.introduce_self();
    ...
    static void demo_2_interaction_equality() {
        ...
        Person_660253 yd1 = new Person_660253("yindee", 2000 );
        Person_660253 pd = new Person_660253("Preeda", 1000);
        System.out.println(yd1.isWealthier(pd));
        Person_660253 yd2 = new Person_660253("yindee",2000);
